...
const CartOrder = ({ onClose }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#2A1A10] to-[#1a0f0a] text-white rounded-3xl p-8 shadow-2xl w-[90%] max-w-lg max-h-[90vh] overflow-y-auto relative border border-[#C19976]/30 transform scale-100 transition-all duration-300">
      {/* Header */}
      <div className="flex justify-between items-center mb-4">
        ...
        <h2 className="text-xl font-semibold text-[#C19976]">
          Complete Your Order
        </h2>
      </div>
