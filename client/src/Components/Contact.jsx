            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-black/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-[#C19976]/30">
                        ...
                        {/* Newsletter Signup */}
                        <div className="mt-10 border-t border-[#C19976]/20 pt-6">
                            <h4 className="text-xl font-bold text-[#C19976] mb-3">Subscribe to our Newsletter</h4>
                            <p className="text-gray-300 text-sm mb-4">Get updates on new blends, promotions, and events.</p>
                            <form
                                onSubmit={(e) => {
                                    e.preventDefault();
                                    // rudimentary local save just to acknowledge subscription
                            ...
                            >
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 bg-white/10 border border-[#C19976]/40 text-white placeholder-white/60 rounded-lg focus:ring-2 focus:ring-[#C19976] focus:border-[#C19976] outline-none"
                                />
                                <button
                                    type="submit"
                                    className="px-6 py-3 bg-[#C19976] text-black font-semibold rounded-lg hover:bg-amber-600 transition"
                                >
                                    Subscribe
                                </button>
                            </form>
